...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link spaced-link" href="index.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link spaced-link" href="Contact.php">Contact</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container mt-4" id="Home_Nav">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <img src="https://img.freepik.com/free-vector/hospital-building-concept-
                illustration_114360-8240.jpg?t=st=1710566506~exp=1710570106~hmac=62ac2c3dec6664
        ...
        <div class="row mt-4">
            <div class="col-md-6 left-content">
                ...
                <p>It has been a prrivilage to build the <span class="blue">Florida Group Of Hospitals</span><br>Our
                    Hospital Provides Facility,For <span class="blue">MultiSpeclity</span>
                    Needs<span class="quot">"</span></p>
            </div>
    ...
    <div class="container mt-4">
        ...
        <div class="row mt-4" id="doctor-grid">
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <img src="https://www.sakraworldhospital.com/doctor-images/222%20x%20250%20Dr.%20Sadiq%20Saleem%20Sikora.png" alt="Doctor 1" class="doctor-image">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.sakraworldhospital.com/doctor-images/222%20x%20250%20Sreekant.png" alt="Doctor 2" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
                        <h3>Dr. Jane Smith</h3>
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.sakraworldhospital.com/doctor-images/222%20x%20250%20Dr.%20Ashok%20(1).png" alt="Doctor 3" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.sakraworldhospital.com/doctor-images/222%20x%20250%20Dr.%20Arjun%20Srivatsa.png" alt="Doctor 4" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.sakraworldhospital.com/doctor-images/222%20x%20250%20Dr.Lorance.png" alt="Doctor 3" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.sakraworldhospital.com/doctor-images/222%20x%20250%20D0c%202.png" alt="Doctor 4" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
        ...
        <div class="row">
            <!-- Left side - Image -->
            <div class="col-md-6">
                <img src="https://images.unsplash.com/photo-1586773860383-dab5f3bc1bcc?
                q=80&w=2027&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVuf
                DB8fHx8fA%3D%3D" alt="Contact Image" class="contact-img">
            </div>
