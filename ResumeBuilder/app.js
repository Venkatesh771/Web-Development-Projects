...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    langDsp = document.getElementById('lang_dsp'),
...
const getUserInputs = () => {
    ...
    let langElem = document.querySelectorAll('.lang');
    ...
    langElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'lang')));
    ...
    return {
        ...
        languages: fetchValues(['lang'], langElem)
    }
};
...
const displayCV = (userData) => {
    ...
    showListData(userData.languages, langDsp);
