	...
	<div class="card card-outline card-primary" style="border-top: 0; background: #e0e0e0; border-radius: 20px; box-shadow: 15px 15px 30px #bebebe,-15px -15px 30px #ffffff; padding: 20px;">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="d-flex justify-content-center align-items-center">
	            ...
	            <button class="btn btn-sm btn-primary" type="button" id="add_mark" style="background: #097969; color: #ffffff; border-radius: 10px; border: 0; margin-top: 15px; padding: 5px 10px;">Add</button>
            </div>
        </div>
    	<hr>
  	...
  	<div class="card-footer border-info" style="background-color: #bebebe; border-radius: 10px;">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  mx-2" form="manage-result" style="background: #097969; color: #ffffff; border-radius: 10px;">Save</button>
  			<a class="btn btn-flat mx-2" href="./index2.php?page=results" style="background: #E0115F; color: #ffffff; border-radius: 10px;">Cancel</a>
  		</div>
  	</div>
	</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
              location.href = 'index2.php?page=results'
					},2000)
				}else if(resp == 2){
